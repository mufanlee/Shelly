...
import com.mufan.shelly.ModulesFragment.OnListFragmentInteractionListener;
import com.mufan.shelly.listItem.ModulesContent.Module;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link Module} and makes a call to the
...
public class ModulesRecyclerViewAdapter extends RecyclerView.Adapter<ModulesRecyclerViewAdapter.ViewHolder> {
    ...
    public ModulesRecyclerViewAdapter(List<Module> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
